...
public class Main {
 ...
 /*
    ...
    public static void main(String[] args) {
        ...
        Account user1_account2 = new Account(2222, 12000);
        Account user2_account1 = new Account(3333, 15000);
        Account user2_account2 = new Account(4444, 8000);
        Account user3_account1 = new Account(5555, 5000);
        Account user3_account2 = new Account(6666, 7500);
        ...
        Customer customer1 = new Customer("User1", "password1", Arrays.asList(user_1_account1,user1_account2));
        ...
        while (true){
            ...
            switch (userChoice){
                ...
                case 1:{
                    ...
                    System.out.println("işlem sonrası hesabınızdaki toplam para " + secilenHesap.funds);
                    break;
                }
