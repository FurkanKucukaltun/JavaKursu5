...
import Gun31._02_Enum.User;
import _04_Projeler._05_Proje.Mortgage.Users;
...
public class HousePrices extends Users {
    ...
    public String getWhichCondtiton() {
        return super.getWhichCondtiton();
    }
    ...
    public int getLongTerm() {
        return super.getLongTerm();
    }

    @Override
    public StatesTax getStatesTax() {
        return super.getStatesTax();
    }
   ...
   */
    ...
    */
    ...
    public int getPriceEachMonth(){
        int monthlyprice=(price-getDownPayment())/getLongTerm();
